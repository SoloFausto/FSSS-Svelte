...
Currently the software supports being ran as a progressive web app, or simply by the browser; there is a hosted version in [my domain](fsss.deleonbytes.work) already
